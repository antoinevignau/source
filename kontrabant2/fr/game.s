...
ptrPREFIX	=	$280
ptrIMAGE	=	$1000
ptrUNPACK	=	$2000	; was $b000 then $b400
proBUFFER	=	$0c00	; was $bb00
PRODOS	=	$bf00
MACHID	=	$bf98
...
main_loop	lda	#FALSE	; for restart
	...
	lda	#$ff
	sta	oldLOCATION	; image en mémoire
...
pi_read	lda	iOPEN+5
	...
	cmp	#$4c	; End of file has been encountered
	bne	pi_err	; and we requested $2000 bytes
	clc		; so... clear the error
...
pIMAGE	str	"KONTRAxx.LZ4"	; FR version -5 as "DATA/" was moreved

iOPEN	dfb	$3
	da	pIMAGE	; pathname (par défaut, le moteur)
