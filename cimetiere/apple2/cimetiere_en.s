...
:4025	@LOCATE	#4;#1;#1
	@message	#6	; vous voyez
	@PEN	#4;#1
	@LOCATE	#4;#10;#1	; affiche la chaîne des objets
	@LET	#U$;#T$	; LET U$ = T$
	@LOWER	#U$
...
:4502	lda	I
	ldx	#8	; index pour Guard's Medal
	cmp	#12
	beq	:4509
	cmp	#23
	beq	:4508
...
:4504	inx		; 32 night flower
:4505	inx		; 30 poacher's cloak
:4506	inx		; 29 incense stick
:4507	inx		; 27 stele fragment
:4508	inx		; 23 engraved stone
:4509	txa		; 12 guard's medal
	jsr	printMESSAGE
...
:4530_NEXT	ldx	I
	...
	@LOCATE	#0;#9;#24	; #0;#30;#23 in MODE 2
	@message	#14
	@INKEY
