...
tblLOCATIONS
	asc	"WELCOME TO THE FIRST SLOVENIAN ADVENTURE!!!"8D8D"The goal of the game is known to you. The computer will guide you through familiar and unfamiliar places, and you will advise it in simple English on what to do"8D8D
	ASC	"Don't give up too quickly; we also need a few hours to finish, even with a map and a scenario. Everything that happens has its purpose."8D8D"We wish you as much fun as possible:"8D8D
	ASC	"Turk Ziga and Kmet Matevz"8D"P.S. Prizes await the best!"00

	asc	"Life is becoming more and more boring during the dry season. Television repeats old movies, the radio is full of sadness, and the news in the newspapers isn't even worth mentioning."8D8D
	ASC	"THE ONLY SOLUTION IS FOR YOU TO FIND A TV, A CASSETTE PLAYER, AND A MICROCOMPUTER. THE ONLY WAY LEADS OUT into the wider world."00

	asc	"You are standing at a famous European crossroad somewhere in the middle of Ljubljana. Wide, modern six-lane highways lead in all directions. An older man approaches you."00
	asc	"You are on a hill. There is also a pleasant inn there, in front of which sits a man with a big moustache who asks you for a glass of rum. The paths lead to the E, N, and NW."00
	asc	"You have entered the eighth barrack of a large contraceptive camp. Everything around is full of students, and the exits lead to NE, S, and DOWN."00

	asc	"You are knee-deep in stinking swamp water. Your feet are very cold, and you want to get out of here as soon as possible. In the distance, you see a large white building with the words:..."
	ASC	"FIRE PROTECTION. The roads lead to the N, S, E, and SW."00

	asc	"You are in a large factory that smells of shoe polish, shampoos, and paraffin."00
	asc	"In the twilight, you see many abandoned tombstones, one of which even lies on the ground. The atmosphere is very eerie. Sandy paths lead to the N, W, and SW."00
	asc	"There are large fields around you. A farmer, who is plowing with a computer-controlled plough, tells you: 'Hg + Au = amalgam for fillings.' The roads lead to the N and E."00
	asc	"You are standing in front of a modern factory, around which happy babies are playing. A security guard shows you the paths leading to the N and S."00
	asc	"In front of a house sits a Turk, addicted to LSD, muttering to himself: 'I KNOW BUT I DON'T SAY, I KNOW BUT I DON'T SAY...' Narrow streets lead to the S, W, N, and SE."00
	asc	"Wrapped in a mysterious mist, the famous SPARK factory rises in front of you. There they are developing a new microcomputer - the HR 1884. Help them and you will get one! The paths lead to the E and SE."00
	asc	"You are in the death town of our great poet, who walks around you all excited and says: 'I am here if you need me!' Bad roads lead to the E, W, and SE."00    ; **27 3 2025**

	asc	"The town you are in is festively decorated because Mayor Marry is getting married to Matthias. There is a seminar for computer programmers in a building."
	ASC	"Everyone is very smart, so it is best to get away to the SW or E."00

	asc	"You have arrived at a world-famous resort where you can relax. In the direction of the W, you see an island in the middle of a lake. The exits are to the NE, N, and NW."00
	asc	"You are on an island. There is a small church cared for by nuns. Many stories take place on this island. You can also see the wishing bell."00
	asc	"In front of you is a boat rental house. A fat guard sleeps soundly in front of it. The exits are to the S, SE, and NE (from the NE you see something bright in the distance, but it is not the future)."00
	asc	"The flash from the factory where they work with a large ELAN blinds you. The meadows spread to the E, S, and SW."00
	asc	"You are in the center of the Carniolan smuggling trade. The shoes can do it themselves, but the rest 'THEY ARE WALKING UP.' The mountain paths lead to the S, N, W"00
	asc	"In a violent noise, planes take off from the airport, which is the second largest in the world after Maribor."00
	asc	"You are in the Slovenian metropolis Kamnik. A worker in the local factory ROPEVILLAGE tells you: 'A tie is not a slipper; a tie is for around the neck!' If you want to leave, go E or W."00
	asc	"A pleasant smell of old greasy donuts penetrates your nostrils. But the girl says: 'Peter told me that he eats them every day for dinner.' If they stink, go to the E or W."00
	asc	"Before you spread large fields of green gold. From it, the best beers in our country are made. Field paths lead to the E, W, and S."00
	asc	"You are in Celje Castle, where the air is not that bad because of the altitude. There is a large suit of armor in the room. Narrow, steep paths lead to the W and DOWN."00
	asc	"You have arrived in Celje, the city of goldsmiths. The air is heavily polluted, so be careful! The cleaner air is to the N, NE, E, and UP."00
	...
	asc	"You are in the pride of Marlboro, in Maribor. After taking the metro, you come to a quiz where they ask: 'What is RED and BLACK at the same time?"00
	asc	"You are in a small town in the east. There is a man there who has many relatives. That is why he boasts: 'My uncles told me that you should take care of your beards!'"00

	asc	"In front of you stands the famous fortress of Dr. Rogelj, where computer addicts and those with liver cellulose are treated. Even Kovi Janicic comes here too..."
	ASC	"The well-maintained paths lead to the N, E, SW, SE, and W."00

	asc	"You are in the studios of the big radio, where they broadcast milk every day. In the studio lie a few drunk technicians: Ciril, Metod, and Mickey Mouse."
	ASC	"Here it's getting more and more like HOCUS POCUS. You can only escape UP by the stairs."00
	
	asc	"You see the famous slope of the poor in front of you. At the top of the slope, a mother sits holding a cup of coffee in her hand, being poured by a certain Martin."
	ASC	"The paved macadam roads lead to the NE, SW, and E."00
	
	asc	"You are in front of the entrance to the technical museum. To avoid damaging anything, go to the N, E, and W."00
	asc	"You have reached the customs house in Ljubelj. Immediately after the gate, there is a long, dark tunnel. If you don't want to go there, you can go to the S."00
	asc	"Boiling water is spraying out of the ground everywhere, but where it doesn't, there is a vineyard. The climate is favorable and suitable for rest. The exits are to the N and S."00
	asc	"You have arrived at the famous textile center, where modern clothes have been made since the Stone Age. The road leads in the SE direction."00
	...
	asc	"You are in Slovenian New York. You see an overgrown artist making paintings. He says he would like a sip of cold beer. The roads lead to the E, W, N, and S."00
	asc	"In the city that has the first nuclear power plant in our country, you have nothing to do, so go to the N, E, or W."00
	asc	"You are in Zagreb at the Fair. Bring your computer, and you will get a vacuum cleaner. You can go to the N, S, E, NE, and W."00
	asc	"The city you are in boasts a huge factory of wooden sticks with red heads. Above the entrance to the factory, there is a sign: WE NEED YOU!!! The paved roads lead to the S, E, and W."00
	asc	"You are in a white city, the capital of our homeland. There is a large building of paragraphs on the N side. Tell the correct currency and enter or go to the W, N, or S."00
	asc	"From afar, you can see Vucko, who watches over our only (for now) Olympic city. Almost impassable paths lead to the N, SE, S, and E."00
	asc	"You are in a city where the Morava never runs out. Everyone in the city is listening to someone who says it is very beautiful. The streets go in the N, S, W direction, and INSIDE the ???"00
	asc	"You are in front of a nice cafe. Everyone in it is crazy about coffee, and they exchange it for cassette players in large quantities. Return can only be OUT."00
	asc	"You have arrived at a famous confectionery center. It smells pleasantly from the W. The exits are to the N, NW, and S."00
	asc	"All around you are only black mountains. The paths lead to the E and N."00
	asc	"You are in a city through which an extremely clean river flows. The stench will sooner or later drive you to the N or NW."00
	asc	"You are standing in the middle of a dark forest. From far away, you can hear the howling of wolves and bears. Your chances of survival are minimal. The paths between the trees lead to the S and W."00
	asc	"The town you are in is famous for its dry goods. Their barrels are the best. Urban tells you: 'I'll give you the product for the raw material!' The roads go E, SE, and NW."00
	asc	"Everything around you smells of roasted barley because the town has one of the best breweries in the world. You can go N and S."00
	asc	"On a small hill stands a monument to a famous smuggler of books. Even today, you can get many interesting things here, because people here temporarily work abroad. The roads lead NW and SE."00
	asc	"On the threshold of his birthplace sits Desnstik, and you say: 'Go from Litija to Catez, and you will experience many interesting things!' Crossing diagonals."00
	asc	"The fairy tale says that witches once gathered on the hill where you stand. All that remains of them is a stone on which they sometimes killed their enemies. The forest path leads DOWN."00
	asc	"You are in a wide karst field. The Slivnica rises above you, and the path leads to the N."00
	asc	"You are in Keltska Bistrica, an intermediate station between Rijeka and Postojna. You can go NW and SE along beautiful roads."00
	asc	"You are in a large port city, which is full of suspicious types from all over the world. Watch out for them! The roads overland lead to the N, W, and NW."00
	asc	"You are in the birthplace of our famous boxer Mate Parlow. There is also a bakery where Pate started his journey. The roads lead to the N and NE."00    ; **27 3 2025**
	asc	"You are in the Yugoslav Silicon Valley, where the famous DIGITRON calculators are manufactured. The roads lead to the N and S."00
	asc	"You are in the port of Rose, where everything is full of tourists. On a wall, it is written in large letters: DO NOT BREATHE BY MY COLLAR! You can go N or S."00

	asc	"Beautiful mares gallop in front of you, the kind used by all smugglers. In the background is the administrative building, where they place the queue orders for them."    ; **27 3 2025**
	ASC	"They also accommodate guests, who pay well. The path leads from N to S."00

	asc	"You are in front of the entrance to a large, dark cave, which lies to the N. If you are not a caver, go NE, SE, or SW."00
	asc	"You are in a place surrounded by forests all around. From old times, there is a tradition that travelers are robbed here. But you can escape to the NE, W, and SW."00
	asc	"The old mining town greets you and offers you all of its wealth. Remember a certain message and don't take what you don't need. The path goes E and SW."00
	asc	"As long as you keep saying that, I don't think of helping you. Because of me, you can get a doctorate at this location. Where the paths lead, you'll have to find out for yourself."00
	asc	"They are watching you; a wrong move can be fatal."00
	asc	"They are watching you; a wrong move can be fatal."00
	asc	"It's hot. The right word in this place saves you, the wrong one destroys you."00
	asc	"You are at the entrance to an underground cave. Ice-cold water drips from the ceiling, and somewhere in the depths, a river roars. Narrow corridors lead to the N, S, and W."00
	asc	"You are in a cave. It's very cold. On the wall, it's written in charcoal: DO NOT GO ANY FURTHER! Wet paths lead to the S and SW."00
	asc	"You are in a cave. You can see a little bit. The paths lead to the S and W."00
	asc	"You are in a cave. You can see a little bit. The paths lead to the N and E."00
	asc	"You are in a cave. You can see a little bit. The paths lead to the S, W and NE."00
	asc	"You are in cave. You can see a little more. The paths lead to the E and W."00
	asc	"It's getting brighter - you're in a forest cave. The paths lead to the S, E, W, and NW."00
	asc	"You're in the forest. The paths lead to the N and E."00
	asc	"You're in a dark, old forest. The paths lead to the N, NE, E, and W."00
	asc	"You're in a dark, old forest. The paths lead to the W and SE."00
	asc	"You're in a dark, old forest. The paths lead to the N and E."00

	asc	"You're in a dark, old forest. The paths lead to the S, E and W."00
	asc	"You're standing in the blue room of the hidden castle. The large chamber is to the W."00
	asc	"You're in Predjama Castle, standing in the red room. The exits are to the N, E, and SW."00
	asc	"You are in the purple room."00
	asc	"You are in the green room. The carpets go to the NE and W."00
	asc	"You are in the yellow room."00
	asc	"You are in the white room. The only door is to the W, and the stairs lead DOWN. There is a telephone on the wall, and in the directory, it says: 'Call in distress: 061-313715'"00
	asc	"You are in a purple room."00
	asc	"You are standing among strange stones. The place smells of death. You hear laughter from the S. The roads lead to the W, NE, S, and SE."00
	asc	"In front of you is a lake, and on it is a wooden cottage on stilts. Beaver Janez knows where the boat is. On the other side of the lake, you see the HOLY TRINITY."00
	asc	"You are a real hook (root)! 'Swim further south.'"00
	asc	"You are in a tunnel. There is darkness around you, but you don't need to be afraid, because there are two of us."00
	asc	"You are in a tunnel that connects us to AU.. uncles and AU.. aunts. Get through it!"00
	asc	"You are still in the tunnel. Hurry up, because the air is very bad and it is already hard to breathe."00
	asc	"You are at the exit in a large tunnel. Don't wait, but leave as soon as possible!"00
	asc	"You are still walking through the tunnel. A breath of fresh air is coming from somewhere, so don't give up."00
	asc	"You are in the Austrian part of the tunnel. Choose the country you would like to go to and do it."00
	asc	"You are at the Austrian entrance to the tunnel. The wall says with a welcome: 'Hier wird Deutsch gesprochen!'"00
	asc	"You are in the Austrian customs office. They ask you about Sliwowitz, and to avoid temptation, that thing isn't even in the game."00
	asc	"You're in the mountains. You hear a flock of sheep and the yodeling of their shepherd, who knows all the border guards. A narrow path leads to the E."00
	asc	"CAMBIO-WECHSELSTUBE-EXCHANGE. You are standing in front of the Slovenian VELIKE shopping center. Their motto is: COME, SEE, BUY, GO. After shopping, you can visit N, S, and NE."00
	asc	"You are at the Prince's Stone. With a little imagination, you can envision images of the past."00
	asc	"Du stehst vor einem Kasino neben Worther See.Um einzutreten mus man eine Krawatte haben. Strasen fuhren nach Ost,West und Sud."00
	asc	"Du bist im Klagenfurt. Hier gibt es viele Sachen, aber du hast nicht genug Zeit und Geld.Gassen fuhren nach Nord,West und Nordwest."00
	asc	"Du bist an einem See.Man sagt, das hier einmal auch ein Held, Tzchrthomyr genannt lebte.Du kannst zum Nordwest gehen."00
	asc	"In Wein trinken alle Leute Wien. Aber du must die Reise fortsetzen.Grose Strassen gehenn ach Ost und Sudost."00
	asc	"Jetzt bist du im Munchen.Hier kann man gute Computer und Bier kaufen.Winklige Strassen fuhrenn ach Ost,West und Sud."00
	...
	asc	"Jetzt bist du in einem grosen Geschaft fur Computer.Du siehst viele Computer,aber welcher ist der beste? Ist es der von CBM oder SPECTRUM?"00    ; **27 3 2025**
	asc	"You are in one of the sights of Munich's Sex Shop. The pictures on the walls are tempting but..."00
	asc	"You are in the casino. Take the big roulettes and slot machines and give the money to the people."00
	asc	"You are in a labyrinth of paragraphs. The paths lead in all directions, but watch out for the holes in the law."00
	asc	"You are in a labyrinth of paragraphs. The paths lead in all directions, but watch out for the holes in the law."00
	asc	"You are in a labyrinth of paragraphs. The paths lead in all directions, but watch out for the holes in the law."00
	asc	"You are in a labyrinth of paragraphs. The paths lead in all directions, but watch out for the holes in law."00
	asc	"You are in a labyrinth of paragraphs. There is also Jernej, who is looking for a license to import a microcomputer."00
	asc	"You are in the treasury. In the wall is a vault that can only be opened by a magic word, which is written in thick black felt-tip pen on the back of one of the kiosks near Figovec."00
	asc	"You're on the right track, only forward to S."00
	asc	"You are standing by a strange lake, where the hero Crtomir lives, who needs female company."00    ; **27 3 2025**
	asc	"You are standing high in the mountains. Around you are sheep, and also their shepherd, who likes to look at the pictures."00
	asc	"Across the mountain pasture jumps joyful Kekec and sings songs about his heroic deeds."00
	asc	"Pehta has come to you, who beats you for a piece of bread. Give her something, so she doesn't eat you!"00    ; **27 3 2025**
	asc	"You are on a small island in the middle of a lake. Their protege Vragumila is sunbathing on a deckchair in the middle of the nuns. She is thinking about your beloved, but he can't go there."00
	asc	"You're in a small village. It's so cold that you're completely numb."00
	asc	"You're at Bedanec (Misery man). There's nothing to see, because everything is miserable."00
	asc	"The little wheat girl guards the flour. As for the roses, she is completely unhappy."00
	asc	"You're in a meeting at the Navje bowling club. Because the fights are interesting, there are lots of stones there to sit on."00
	asc	"Around you is the area of the gang Socks. Watch out for dangers."00
	asc	"You are in Celeia Castle. Enjoy it, because it only exists today and never again."00
	asc	"You are in the city of three stars. If you know the magic word, you can go to Mount Peca, but be careful, because things are very delicate."00
	asc	"King Matthias sits at the table. A long dirty beard is wrapped around the table. You can get a sword here."00
	asc	"You are in a castle where only nice people live, who are worth kidnapping."00
	asc	"Ursula is waiting for the boys on the dance floor from the River Research Society. Leave everything you don't need, because there's dancing here."00
	asc	"Below you see a city guarded by a green dragon. On the castle tower, it says: ATTENTION, FRESHLY PAINTED!!!"00
	asc	"Everything smells of the intoxicating scent of roses. But roses have painful thorns, which is why you need gloves."00
	...
	asc	"You are standing by the sea. There also stands the ugly Vida, who can no longer do the daily washing of diapers. She also has all the necessary diving equipment from her husband."00
	asc	"You are in a clearing in the middle of the forest. The paths go S, E, W, and NW."00
	asc	"You are in the castle where Frederick lives, who only wants Veronika. Help him, and he will reward you!"00    ; **27 3 2025**
	asc	"You are by the Kolpa river. The people here are very strong; some, like Klepec Tepec, will uproot whole trees if he only eat something sweet."00
	...
	asc	"The cave alone and the darkness."00
	asc	"The cave alone and the darkness."00
	asc	"Very dense forest."00     ; **27 3 2025**
	asc	"Very dense forest."00     ; **27 3 2025**
	asc	"Very dense forest."00     ; **27 3 2025**
	asc	"Very dense forest."00     ; **27 3 2025**
	asc	"Very dense forest."00     ; **27 3 2025**
	asc	"You are in the forest cave. Only then- THE STRONGEST STAY!"00
	asc	"You are in the knight's room."00
	asc	"You are in the castle where Predjama Erazem lives."00
	...
	asc	"You are on a drawbridge, which is closing rudely. A servant comes out of the castle with a trash can."00
	asc	"You are in an apartment. You only see a table and a chair."00
	asc	"You are in poppy country. It is hot, so go back north."00
	asc	"All around are fields of wheat. Straight roads lead E and S."00
...
tblMESSAGES
	asc	"You"A7"re naked. Veronika blushes."00
	asc	"You"A7"ll regret it!"00
	asc	"You"A7"re in Slovenia, so speak to me in Slovenian, you idiot!"00
	...
	asc	"Uh! This will fit me just fine, since we"A7"ve been walking for a long time."00
	asc	"Right. I"A7"m rested, so let"A7"s go."00
	asc	"The game is over, it was a wild dance,"00
	asc	"Grateful man gives you an imported TV set from an abandoned program."00     ; **27 3 2025**
	asc	"Glowing Frederick takes Veronika, and in gratitude gives a pot of gold."00    ; **27 3 2025**
	asc	"PUFFF ..."00
	asc	"Frederick doesn"A7"t like the expression on Veronika"A7"s face anymore. He pulls out a sword and plunges it into your ribs. What a wild time!!!!"00    ; **27 3 2025**
	asc	"Fancy Veronika didn"A7"t polish you!"00
	asc	A2"Let"A7"s go, dear,"A2" she decides, and then quickly jumps into your arms."00
	asc	"Veronika has already slipped out of her tight jeans and is seductively inviting you to her."00
	asc	"She slaps you. Ugh, how strong girls from fairy tales are. Wake up."00
	asc	"Squeak...Squeak...Squeak...(5 points)"00
	asc	"Herman of Celje takes Veronica from you."00     ; **27 3 2025**
	asc	"Herman wants to keep Veronica, but your sword won"A7"t let him near it."00
	asc	"Matej shows you the glove up close...chirp..chirp..chirp"00
	asc	"They give you the apprentice Matej, who rides the blunt shoulder..."00
	asc	"In exchange for the dear guest you have protection for the order."00
	asc	"You are registered under No. 1921212, PLEASE ALLOW US UP TO 28 DAYS FOR DELIVERY"00
	asc	"Man pins a badge on your chest and wish you good luck."00    ; **27 3 2025**
	asc	"THANKS !"00
	asc	"Left eye is purple"00
	asc	A2"Mmm, che buono!"A2" says Tepec and puts down the beautiful oak planks that is holding."00    ; **27 3 2025**
	asc	"Urban gives you barrels, saying: "A7"Such barrels were made by my father for corrupt pastor."A700    ; **27 3 2025**
	asc	"Trubar: "A7"I"A7"m already too old to smuggle and contraband. Put Spectrum into barrel and it will be ok."A700    ; **27 3 2025**
	asc	"Don"A7"t give up now, it will happen !"00
	asc	"Peek a Boo, I"A7"m still here...(keyboard, there"A7"s not enough armor for the whole HR in this game)."00
	asc	"SILENCE, WE"A7"re WORKING!"00
	asc	"OH DEAR, SUCH A VACUUM CLEANER BETWEEN YOUR LEGS IS EVERYTHING ELSE THAN A BROOM, IT"A7"s WORTH TO SPELL FOR IT."00
	asc	"You see a big hole in the ground."00
	asc	"They"A7"re attacking you, but your armor can hold it."00
	asc	"Greed without armor is a terrible sad thing."00
	asc	"The treasure is buried. (why are you doing this, I like it here more)"00
	asc	"You dug up the treasure."00
	asc	"Everything is for nothing now, you destroyed the shovel."00
	asc	"The moons are sinking into the sweetness of the joystick, and Bogomila rushes into your embrace."00    ; **27 3 2025**
	...
	asc	"You returned Bogomila to me - thank you, we will be left alone now, and I gave you Sinclair."00    ; **27 3 2025**
	asc	"Come on! You are not a baby!"00
	asc	"Rozle is lost in the pictures, he let the flute to be yours."00
	...
	asc	"The customs officer doesn"A7"t fall for it: this is an old trick, hiding things in barrels."00
	asc	"A Bedanec shot from a distance just before the end, knocked down the brave unarmed adventurer."00    ; **27 3 2025**
	asc	"You must have a valid passport and export some high technology, and you can come through!"00    ; **27 3 2025**
	asc	"They plucked you to the last drop!"00
	asc	"Bravo!!! The secret password is: storm"00
	asc	"I swim, I swim, I swim, I swim like a guinea pig."00
	asc	"Beautiful Ursula is not grateful, but  pours you a bucket of ice-cold water.... You"A7"re slowly coming to your senses."00
	asc	"You can only buy here with convertible currencies."00
	asc	"You don"A7"t have money???"00
	asc	"Boooooom..."00
	asc	"Crtomir thanks you, he gives you five percent."00
	asc	"Beautiful Vida stood by the sea, she gave you a mask for diapers."00
	asc	"I don"A7"t see anything special."00
	asc	"Bravo! The answer is correct, that"A7"s why you got the Attache collection!"00
...
tblOBJECTS
	...
	macOBJ	O_NOTCRE;	"Microcomputer-Do It-Yourself book"
	macOBJ	O_NOTCRE;	"double-bottomed barrel"
	macOBJ	O_NOTCRE;	"oak planks"
	macOBJ	21;	"donut"
	macOBJ	O_NOTCRE;	"deutsche mark"	;**27 3 2025**
	macOBJ	O_NOTCRE;	"magic armor"
	macOBJ	O_NOTCRE;	"turbo vacuum cleaner"
	macOBJ	O_NOTCRE;	"flute"	;**27 3 2025**
...
tblSYSMESSAGES
	...
	asc	8D"You have: "00	; **fixed*
	asc	" (worn)"00     ;  **27 3 2025**
...
*	macWORD	18;"	; "UTRG"
	...
	macWORD	22;"TAPE"	; "KASE" **27 3 2025**
...
*	macWORD	25;"	; "PRST" 		 - NOT SURE I THINK IT SI NOT USED
	...
	macWORD	30;"BARR"	; "SOD" 
	macWORD	31;"WOOD"	; "LES" 
	macWORD	31;"PLAN"	; "DESK"/"BOAR"
	macWORD	31;"OAK"	; "HRAS"
	macWORD	32;"DONU"	; "KROF" ** fixed **
	macWORD	33;"DEM"	; "MARK"
	macWORD	34;"ARMO"	; "OKLE"
	macWORD	35;"VACU"	; "SESA"
	macWORD	36;"FLUT"	; "PISC" **27 3 2025**
	...
	macWORD	47;"FLAS"	; "BATE" **fixed**
*	macWORD	47;"LIGH"	; "BATE" **fixed** **removed in favor of the verb**
	macWORD	48;"HG"	; "HG"  
*	macWORD	48;"	; "ZIVO"
...
*	macWORD	53;"	; "LIST"
	...
	macWORD	54;"WEAR"	; "OBUJ" **added** to wear
*	macWORD	54;"	; "PRIP"
	macWORD	55;"UNWE"	; "SLEC"
	macWORD	55;"UNDR"	; "ODPN" **added** undress
*	macWORD	56;"GO"	; "GO"   **removed**
*	macWORD	56;"EAT"	; "EAT"  **removed**
*	macWORD	56;"USE"	; "USE"  **removed**
*	macWORD	56;"TAKE"	; "TAKE" **removed**
*	macWORD	56;"DROP"	; "DROP" **removed**
*	macWORD	56;"LOOK"	; "LOOK" **removed**
...
*	macWORD	57;"	; "PICK"
*	macWORD	57;"	; "KURC"
	macWORD	59;"POWE"	; "PRIZ" **fixed**
	macWORD	59;"LIGH"	; "LIGHT" 30/3/2025
	macWORD	60;"GIVE"	; "DAJ" 
	macWORD	60;"DROP"	; "SPUS"
*	macWORD	60;"	; "ODLO"
	macWORD	61;"LOOK"	; "OPIS" **27 3 2025**
	macWORD	61;"L"	; short for LOOK 30/3/2025
...
*	macWORD	66;"	; "PODR"
	...
	macWORD	70;"ORDE"	; "RED"  **27 3 2025** 
*	macWORD	70;"	; "VRST"
	macWORD	71;"MATE"	; "MATE" **27 3 2025**
...
*	macWORD	79;"	; "ZAME"
	macWORD	80;"BURY"	; "ZAKO" **27 3 2025**
	macWORD	81;"DIG"	; "ODKO" **27 3 2025**
...
*	macWORD	153;"	; "POPI"
	...
	macWORD	156;"ADVI"	; "SVET" **27 3 2025**          
