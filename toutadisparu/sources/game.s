...
add_char1
	rep	#$30
	lda	1,s	; rŽcupre RTS
	plx		; dŽpile les paramtres
	plx
...
charcmp
	...
	ldx	#FALSE	; default value, les cha”nes sont diffŽrentes
...
instr
	...
	iny
	cmp	5,s
	beq	instr2	; on a trouvŽ le caractre
	tya
	cmp	7,s
	bcc	]lp
*	beq	]lp
instr1
	ldy	#-1	; on n'a pas trouvŽ le caractre
