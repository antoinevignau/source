...
*-------------- PLATFORM_BEEP (Music Games by Lydia Bell, Sams Publishing)

platform_beep	stx	snd_03
	stx	snd_01
	sty	snd_00
...
*	hex	70,71,72,73,74,75,76,77,78,79,7A,7B,7C,7D,7E,7F
	...
	hex	A0,A1,A2,A3,A4,A5,A6,A7,A8,A9,AA,AB,AC,AD,AE,AF
	hex	B0,B1,B2,B3,B4,B5,B6,B7,B8,B9,BA,BB,BC,BD,BE,BF
	hex	DA,C1,C2,C3,C4,C5,C6,C7,C8,C9,CA,CB,CC,CD,CE,CF
	hex	D0,D1,D2,D3,D4,D5,D6,D7,D8,D9,DA,D3,C4,C3,C3,DF
	hex	FA,E1,E2,E3,E4,E5,E6,E7,E8,E9,EA,EB,EC,ED,EE,EF
	hex	F0,F1,F2,F3,F4,F5,F6,F7,F8,F9,FA,F3,E4,E3,E3,FF
