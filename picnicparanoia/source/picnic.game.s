*
* Picnic Paranoia ProDOS
* From the unprotected source code
*
* (s) LoGo, 2020
*
...
OFFSET	=	$60	; from $2000 + OFFSET = off screen
L0400	=	$0400	; GR area
L8000	=	$8000	; this is where the background gameplay image is, now at $9000
L8228	=	L8000+$0228
L9800	=	L8000+$1800	; this is the RAM area of the background gameplay
LA000	=	$A000
PRODOS	=	$BF00
...
* $0310..$03FF : data
* $0800..$1FFF : code and data
* $2000..$3FFF : HGR1
* $4000..$7FFF : code and data
* $8000..$9FFF : off screen
* $A000..$BFFF : copy of title page
...
L0FA0    hex   9F00CC00C90094D494D4C900CC009F00
L0FB0    hex   FF00FC00930094D49495E4009F00FF00
L0FC0    hex   9F00FC00E300E9AAE9A8E3009F00FC00
L0FD0    hex   FF009C00E300E9AAE9A8E3009C00FF00
L0FE0    hex   99009900E700E1808780E70099009900
L0FF0    hex   9C009C00F300E780F380E7009C009C00
...
DESTBYT2 hex 444C545C505450545054504C545C88909894909490949094889098A000000000
       *or $10C0
AAMSBYT  dfb >L1A90,>L1AC0,>L1AF0,>L1B20,>L1B50,>L1B80,>L1BB0,>L1BE0
	 dfb >L1C10,>L1C40,>L1C70,>L1CA0,>L1CD0,>L1D00,>L1D30,>L1D60
	 dfb >L1D90,>L1DC0,>L1DF0,>L1E20,>L1E50,>L1E80,>L1EB0,>L1EE0
	 dfb >L1F10,>L1F40,>L1F70,>L1FA0,>L1FD0
         hex 000000
       *or $10E0
AALSBYT  dfb <L1A90,<L1AC0,<L1AF0,<L1B20,<L1B50,<L1B80,<L1BB0,<L1BE0
	 dfb <L1C10,<L1C40,<L1C70,<L1CA0,<L1CD0,<L1D00,<L1D30,<L1D60
	 dfb <L1D90,<L1DC0,<L1DF0,<L1E20,<L1E50,<L1E80,<L1EB0,<L1EE0
	 dfb <L1F10,<L1F40,<L1F70,<L1FA0,<L1FD0
...
L1B00    hex   00000000004000000000400000000000
         hex   00000000000000000000000000000000
L1B20    hex   00000000404040404040404040404040
         hex   40404040404000000000404040404040
         hex   40404040404040404040404000000000
L1B50    hex   00000000400000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000004000000000
L1B80    hex   00000000400000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000004000000000
L1BB0    hex   00000000400000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000004000000000
L1BE0    hex   00000000400000000000004040404040
         hex   40404040404000000000404040404040
...
L1CA0    hex   00000000400000000000004050504040
         hex   40404040404000000000404040404040
         hex   40535353400000000000004000000000
L1CD0    hex   40404040400000000000004040404040
         hex   40404040404000000000404040404040
         hex   40404040400000000000004040404040
L1D00    hex   00000000000000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000000000000000
L1D30    hex   00000000000000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000000000000000
L1D60    hex   00000000000000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000000000000000
L1D90    hex   40404040400000000000004040404040
         hex   40404040404000000000404040404040
         hex   40404040400000000000004040404040
...
L1E50    hex   00000000400000000000004040404040
         hex   40405555554000000000405656565640
         hex   40405757400000000000004000000000
L1E80    hex   00000000400000000000004040404040
         hex   40404040404000000000404040404040
         hex   40404040400000000000004000000000
L1EB0    hex   00000000400000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000004000000000
L1EE0    hex   00000000400000000000000000000000
         hex   00000000000000000000000000000000
L1F00    hex   00000000000000000000004000000000
L1F10    hex   00000000400000000000000000000000
         hex   00000000000000000000000000000000
         hex   00000000000000000000004000000000
L1F40    hex   00000000404040404040404040404040
         hex   40404040404000000000404040404040
         hex   40404040404040404040404000000000
...
L1FA0    hex   00000000000000000000000000000000
         hex   00000000004000000000400000000000
         hex   00000000000000000000000000000000
L1FD0    hex   00000000000000000000000000000000
         hex   00000000004000000000400000000000
         hex   00000000000000000000000000000000
...
L4000    hex   2A552F2A75302A1D302A1D2C2A072B2B
         ...
         hex   2A
L4021	 hex   2A552A2A552A2A552A2A752F2A1D302B
         hex   0730177E2F166A2A56282C2A29542414
         hex   2A000000000000000000000000000000
         hex   000000000000000000000000000000
L4060    hex   7A552A06572A065C2A1A5C2A6A502A2A
         hex   736A2A2B742A2B341A0A35154A2A2A14
         hex   2A
L4081	 hex   2A552A2A552A2A552A7A572A065C2A06
         hex   706A7A3F742A2B341A0A35154A2A2A14
         hex   2A
L40A2	 hex   2A552A2A552A6A752A7A752B7E752F2A
         hex   552A7E752F7A752B6A752A2A552A2A55
         hex   2A00000F00603F00783F00780F007E03
         hex   037E007F3F007C3F007C7F07007C7F40
         hex   6301114541054511110808222002
...
theRESET	=	*	; This is where the reset vector is
       JMP RESET
...
* We are at $421e (and protection is removed)

       hex F0D14C2342D0EB0F33FC

TABLE132   hex 0008080000000000  
TABLE133   hex 000706050403020100
	
* We are at $4239

         hex   F9FAFBFCFDFEFF
L4240    hex   0A500200021F7E117E1F7A176A576A56
         hex   5A5A566A5FFA5A5A5A5A5A5A0A500A40
L4260    hex   0A500200021F7E117E1F7A176A576A56
         hex   5A5A566A5FFA5A5A5A5A366D22450205
L4280    hex   0A5000407841087F787F685F6A576A56
         hex   5A5A565A5FFA5A5A5A5A5A5A0A500250
L42A0    hex   0A5000407841087F787F685F6A576A56
         hex   5A5A565A5FFA5A5A5A5A366D22452041
L42C0    hex   0A500240025F7E637E7F7A576A576A56
         hex   5AEA565657565256565A366D22450205
L42E0    hex   0A5002407A41467F7E7F6A5F6A576A56
         hex   575A6A6A6AEA6A4A5A6A366D22452041

* We are at $4300

L4300    hex   0A500240025F7E637E7F7AD76AB76AAA
         hex   5A6A565A5F5A565A565A366D22450205
L4320    hex   0A5002407A41467F7E7F6B5F6D575556
         hex   565A5A6A5AFA5A6A5A6A366D22452041
L4340    hex   2A550A500A4002437E4F7E517E4F7A59
         hex   5A565A5A565A566B56ED565502540250
L4360    hex   2A550A5402506241727F0A7F7A7F1A5F
         hex   6A5A5A5A5A6A566B376B2A6B2A400A40
L4380    hex   0A50024C025B7E4B7E7B7A4B6A5A5A5A
         hex   565A6D5A6B5A6A5A5A6A366D22450205
L43A0    hex   2A550A5402506251725F665F7A5F7A57
...
SETUP
       ...
       LDA #$4C		; Reset vector set to zp $31
       STA $31
       LDA #>theRESET	; at $41FF
       STA $33
       LDA #$31
       STA SOFTEV
       LDA #$A5
...
*--- The following code from the protection
...
TABLE11    hex 00
	   dfb >L4240,>L4260,>L4280,>L42A0,>L42C0,>L42E0
	   dfb >L4300,>L4320,>L4340,>L4360,>L4380,>L43A0
TABLE12    hex 00
	   dfb <L4240,<L4260,<L4280,<L42A0,<L42C0,<L42E0
	   dfb <L4300,<L4320,<L4340,<L4360,<L4380,<L43A0
...
*--- The following code was part of the protection
...
TABLE60    dfb <L4000,<L4021,<L4060,<L4081,<L40A2
...
* We are at $6534 (where DIE used to be)
        ...
        hex 	FFFF0000
        hex 	FFFF
L6556	hex     D7AFDFBEFDFAF5EBD7AF
...
L6700	hex	7F7F7F7F787F3F607F1F007F07007C03
	...
	hex	7F617F7F7F7F7F7F
L6748	hex     7F7F7F7F787F3F607F1F007F07007C03
	hex	0070730360737F61737F67737F67437F
	hex	67037867030067330060730760737F60
	hex	737F67637F670F7E677F70677F0F667F
	hex	7F617F7F7F7F7F7F

L6790	hex	FFFFFF8FFEFFE3FCFFD9F9FFACF0FF8C
	hex	E7FFC9CEFFA39BFFE386FEA7B1FEE7E8
	hex	FCCFDCF88FB6F89FC6F2BFD2CABF92CA
	hex	FFD0CAFFD1C8FFD1CAFF93EAFFC7F2FF
	hex	CFF2FFFFFFFFFFFF
L67D8	hex	FFFFFF87FFFFB1FEFFECFCFF96F9FFC6
	hex	FCFFA4E7FFD1CDFFB183FFD398FFB3B4
	hex	FEA7AEFC879BFC8FA3F99FA9E59F89E5
	hex	BFA8E5FFA8E4FFA8E5FF89F5FFA3F9FF
	hex	A7F9FFFFFFFFFFFF

L6820	hex	7F7F7F7F4F7F7F737FAFF3FEA7D1F2AF
	hex	D5EAEBD5EAABD5EAABD5EAABD5EAABD5
	hex	EAAFD5EAAFD5FABFD5FEFFDDFFFFFFFF

L6850	hex	7F7F7F7F7F7F7F7F7F7F7F7F03000070
	hex	D3AAD5F2D3A8D1F2D3AAD5F0D3AAC5F2
	hex	D3A8D4F2D3AAD5F24F2A557C4F2A557C
	hex	3F00007F7F7F7F7F7F7F7F7F7F7F7F7F

L6890	hex	7F7F7F7F0F7867796779077807786779
	hex	6779677963715162544A544A544A544A
	hex	544ABCCFECC6DCCBBCCBECCDBCCBBCCF
	hex	ECCDD4CA544A544A544A00407F7F7F7F

L68D0	hex	7F7F7F7F1F704F774F770F700F704F77
	hex	4F774F77476323052915291529152915
	hex	2915F99ED98DB997F996D99BF996F99E
	hex	D99B291529152915291501007F7F7F7F
...
TABLE100   dfb >L6600,>L6680,>L66C0,>L6700,>L6790,>L6820,>L6850,>L6890
TABLE101   dfb <L6600,<L6680,<L66C0,<L6700,<L6790,<L6820,<L6850,<L6890
TABLE102   dfb <L6640,<L6680,<L66C0,<L6748,<L67D8,<L6820,<L6850,<L68D0
...
TABLE108   dfb <L0840,<L0800,<L0800,<L0860,<L0840,<L0820,<L0820,<L0860
...
*--- We do not need to save the title page now that we have it compressed

       LDX #>LA000	; from $2000 to $a000
       LDY #>L2000
       bit MOVE_MEMORY	; was JSR
...
:21    LDA #$00
       STA CAN_KEY_PRESSED
       LDX PLAYERNUM
       LDA SET_CAN1,X   	; was LDY SET_CAN1,X
       BEQ :22
       LDA #$00			; was missing
       STA SET_CAN1,X
       LDA #$01
...
:18    LDA NO_OF_FOODS2
       BEQ :16			; was :17
       LDA #$02			; was missing
       STA PLAYERNUM		; was STY PLAYERNUM
       BNE :16
:14    LDX PLAYERNUM
       LDA #$00			; was :14
       STA NO_OF_FOODS1,X
...
RESET			; named RESTART on the protected version
       LDA TXTCLR
       LDA HIRES
       lda MIXCLR	; +6 bytes
       lda TXTPAGE1
...
*       LDX #>L2000
*       JSR MOVE_MEMORY
       jsr unpackLZ4	; now call unpackLZ4
...
TABLE312   hex 000000000000000060E060606060
	   hex F00060F0103060C0F000F0101070
	   hex 1010F00080809090F0101000F080
	   hex 80F01010F000F08080F09090F000
	   hex F0103060C0808000F09090F09090
	   hex F000F090F01010101000  
...
* End of code - We must reach $7FFF

	ds	\

*-------------------------------
* The background image - We are at $8000
*-------------------------------

	put	img.back.s

*-------------------------------
* ProDOS version additions - We are at $A000
*-------------------------------

	sec			; if on a IIgs, slow it down
	jsr	IDROUTINE
	bcs	notIIgs

	lda	CYAREG		; one should use the tools instead
	sta	saveC036
	and	#%01111111
	sta	CYAREG

notIIgs
	ldx	#$77		; copy the GR screen
]lp	lda	theLORES,x
	sta	$400,x
	lda	theLORES+$80,x
	sta	$480,x
...
*------------------------------------------
* Some data moved - We are at $8000 now
*------------------------------------------
...
unpackLZ4
	lda	#<picSTART	; set the pointer to the packed data
	sta	src
	lda	#>picSTART
	sta	src+1
	...
	lda	src
	clc
	adc	#16	; size of the header
	sta	src
	lda	src+1
	adc	#0
	sta	src+1
	
	ldy	#0	; our index is 0
parsetoken
	jsr	getsrc
	pha
	lsr
...
*-------------------------------
	...
	put	img.title.lz4.s
	put	lores.s			; loaded at the end because copied at $400
					; then that memory area is used by the off screen page
					
	ds	\

*--- It is the end, LoGo 7/2020
