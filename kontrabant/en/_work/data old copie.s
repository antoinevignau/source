...
tblLOCATIONS
	...
	asc	"You have entered the eighth barrack of a large contraceptive camp. Everything around is full of students, and the exits lead to SE, S, and DOWN."00
	...
	asc	"You are in the death town of our great poet, who walks around you all excited and says: 'If you need me!' Bad roads lead to the E, W, and SE."00
	...
	asc	"You are in the birthplace of our famous boxer Pate Marlow. There is also a bakery where Pate started his journey. The roads lead to the N and NE."00
	...
	asc	"Beautiful horses gallop in front of you, the kind used by all smugglers. In the background is the administrative building, where they place the orders for them."
	...
	asc	"Jetzt bist du in einem grosen Geschaft fur Computer.Du siehst viele Computer,aber welcher ist der beste?Ist es der von CBM oder SINCLAIR?"00
	...
	asc	"You are standing by a strange lake, where the hero Tzchrtomyr lives, who needs female company."00
	...
	asc	"Fehta has come to you, who beats you for a piece of bread. Give her something, so she doesn't eat you!"00
	...
	asc	"You are in the castle where Friderik lives, who only wants Veronika. Help him, and he will reward you!"00
...
tblMESSAGES
	...
	asc	"Glowing Friederik takes Veronika, and in gratitude gives a pot of gold."00	; JANEZ
	asc	"PUFFF ..."00
	asc	"Friederik doesn"A7"t like the expression on Veronika"A7"s face anymore. He pulls out a sword and plunges it into your ribs. What a wild time!!!!"00
	...
	asc	"Herman of Celje (who can still do it today and never again) takes Veronica from you."00
	asc	"Herman wants to keep Veronica, but your sword won"A7"t let him near it."00
	asc	"Matthew shows you the glove up close...chirp..chirp..chirp"00
	asc	"They give you the apprentice Matthew, who rides the blunt shoulder..."00
	...
	asc	"May pin a badge on your chest and wish you good luck."00
	asc	"THANKS !"00
	asc	"Left eye is purple"00
	asc	A2"Mmm,che buono!"A2" says Tepec and puts down the beautiful oak planks that is holding."00
	asc	"Urban gives you barrels, saying: "A7"Such barrels were made by my father for  corrupt pastor."A700
	asc	"Trubar: "A7"I"A7"m already too old to smuggle and contraband. Put Spectrum into barrel and it will be. The book is already old."A700	; JANEZ
	...
	asc	"They"A7"re attacking you, your armor can hold it."00
	...
	asc	"You returned Bogumila to me - thank you, we will be left alone now, and I gave you Sinclair."00
	...
	asc	"A Bedanec shot from a distance just before the end knocked down the brave unarmed adventurer."00
	asc	"You must have a valid passport and export some high technology, and you come through!"00
...
tblOBJECTS
	...
	macOBJ	O_NOTCRE;	"your picture (you"A7"re looking good)"
