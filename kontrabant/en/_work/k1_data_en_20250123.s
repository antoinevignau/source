...
tblLOCATIONS
	asc	"WELCOME TO FIRST SLOVENIAN ADVENTURE !!! The goal of the game is known to you. The computer will guide you through known and unknown places, and you advise it in simple English what to do."
	ASC	"Don't give up too quickly, we also need a few hours to finish, and that's with a map and a scenario. Everything that happens has its purpose. We wish you as much fun as possible: "
	ASC	"Turk Ziga and Kmet Matevz P.S. Prizes await the best!"00
	asc	"Life is becoming more and more boring in the time of dry cows. Television repeats old movies, on the radio sadness itself, don't even think about the news in the newspapers."
	...
	asc	"You are on a hill. There is also a pleasant inn there, in front of which sits a man with a big moustache and asks you for a glass of rum. The ways lead to the E, S and NW."00
	asc	"You have entered in the eighth barrack of a large contraceptive camp. Everything around is full of students, and the exits lead to NE, S and DOWN."00

	asc	"You are knee-deep in stinking swamp water, your feet are very cold, so you want to get out of here as soon as possible. In the distance you see a large white building with the words: ....... "
	ASC	"FIRE PROTECTION The roads lead to the N, S, E and SW."00

	asc	"You are in a large factory, which smells of shoe polish, shampoos and paraffin."00
	asc	"In the twilight you see many abandoned tombstones, one of them even lies on ground.The atmosphere is very eerie.Sandy paths lead to the N, W and SW."00
	asc	"There are large fields around you.A farmer, who plows with a computer-controlled plough tells you: Hg + Au = amalgam for fillings The roads lead to the N and E."00
	...
	asc	"In front of a house sits a Turk, addicted to LSD, and mutters to himself: I KNOW BUT I DON'T SAY, I KNOW BUT I DON'T SAY ... Narrow streets lead to the S, W, S and SE."00
	...
	asc	"The town you are in is festively decorated, because the mayor Marry is getting married to a Matthias. There is a seminar for computer programmers in a building. "
	ASC	"Everyone is very smart, so it is best to get away to the SW or E."00

	asc	"You have arrived at a world-famous resort where you can relax. In the direction of the W you see an island in the middle of a lake. The exits are to the NE,S and NW."00
	asc	"You are on an island. There is a small church there, which was cared by nuns. Many stories take place on this island. You can also see the wishing bell."00
	...
	asc	"You are in the center of the Carniolan smuggling trade. The shoes can do it themselves, but the rest "THEY ARE WALKING UP".The mountain paths lead to the S, S, W."00
	...
	asc	"A pleasant smell of old greasy donuts penetrates your nostrils. But the girl says: "Peter told me that he eats them every day for a dinner". If they stink, go to the E or W."00
	asc	"Before you spread large fields of green gold. From it are obtained the best beers in our country. Field paths lead to the E, W and S."00
	...
	asc	"You are in the pride of Marlboro, in Maribor. After taking the metro, you come to a quiz where you they ask: "What is RED and BLACK at the same time?"00
	...
	asc	"In front of you stands the famous fortress of Dr. Rogelj, where computer addicts and those with liver cellulose are treated. Even Kovi Janicic goes here too ... "
	ASC	"The well-maintained paths lead to the N, E, SW, SE and W."00

	asc	"You are in the studios of the big radio, where they broadcast milk every day. In the studio lie a few drunk technicians: Ciril and Metod and Mickey Mouse. "
	ASC	"Here it's getting more and more like HOCUS POCUS. You can only escape UP by the stairs."00
	
	asc	"You see the famous slope of the poor in front of you. At the top of the slope sits mother and holds a cup of coffee in her hand, which is being poured by a certain Martin. "
	...
	asc	"Boiling water is spraying out of the ground everywhere, but where it does not, there is a vineyard. The climate is favorable and suitable for rest. The exits are on the S and S."00
	asc	"You have arrived at the famous textile center, where modern clothes have been made since the Stone Age. the road leads in the S-E direction."00
	asc	"In the nuclear power plant, only the quiet noise of machines and the switching of relays can be heard. Suddenly, you hear an alarm. On the control desk in front of you, 7 buttons light up. Which one will you press??? "
	ASC	1 2 3 4 5 6 7 oo oo oo oo oo oo oo oo oo oo oo oo oo oo"00
	asc	"You are in Slovenian New York. You see an overgrown artist making paintings. He says he would like a sip of cold beer. The roads lead to the E, W, S and S."00
	asc	"In the city that has the first nuclear power plant in our country, you have nothing to do so go to the S, E or W."00
	asc	"You are in Zagreb at the Fair. Bring your computer, and you will get a vacuum cleaner. You can go to the S, S, E, S and W."00
	...
	asc	"From far you can see Vucko, who watches over our only (for now) Olympic city. Almost impassable paths lead to the N, SE, S and E."00
	...
	asc	"All around you are only black mountains. The paths lead to the E and S."00
	...
	asc	"You are standing in the middle of a dark forest. From far away you can hear the howling of wolves and bears. Your chances of saving are minimal. The paths between the trees lead to the S and W."00
	...
	asc	"Everything around you smells of roasted barley, because the town has one of the best breweries in the world. You can go S and S."00
	...
	asc	"You are in the port of Rose, where everything is full of tourists. On a wall it is written in large letters: DO NOT BREATHE BY MY COLLAR! You can go S or S."00

	asc	"Beautiful horses gallop in front of you, the kind used by all smugglers. In the background is the administrative building, where they enter the order for them. "
	ASC	"They also covet guests, who pay well. The path leads from N to S."00

	asc	"You are in front of the entrance to a large, dark cave, which lies to the N. If you are not a caver, go NE, SE or SW."00
	asc	"You are in a place that is surrounded by forests all around. From old times there is a tradition that travelers are robbed here. But you can escape to the NE, W and SW."00
	asc	"The old mining town greets you and offers you all of its wealth. Remember a certain message and don't take what you need. The path goes E and SW."00
	asc	"As long as you keep saying that, I don't think of helping you. Because of me you can get a doctorate at this location. Where the paths lead, you find out for yourself."00
	...
	asc	"You are at the entrance to an underground cave. Ice-cold water drips from the ceiling, somewhere in the depths a river roars. Narrow corridors lead to the N, S and W."00
	...
	asc	"You are in a cave; you can see a little bit. The paths lead to the S and E."00
	...
	asc	"You're in the forest. The paths lead to the S and E."00
	...
	asc	"You're in a dark old forest. The paths lead to the S and E."00
	...
	asc	"You're in Predjama Castle and stands in his red room. The exits are on the N, E and SW."00
	...
	asc	"You are in the white room. The only door is on the W, and the stairs lead DOWN. There is a telephone on the wall, and in the directory it says: """Call in distress: 061-313715""00
	asc	"You are in a purple room."00
	asc	"You are standing among strange stones. The place smells of death. You hear laughter from the S. The roads lead to the W, NE, S, SE."00
	...
	asc	"You are in Austrian customs office. They ask you about Sliwowitz, and to avoid temptation, that thing isn't even in the game."00
	asc	"You're in the mountains. You hear a flock of sheep and the yodeling of their shepherd, who knows all the border guards. A narrow path leads to V."00
	asc	"CAMBIO-WECHSELSTUBE-EXCHANGE You are standing in front of the Slovenian VELIKE shopping center. Their password is: COME, SEE, BUY, GO After shopping, you can visit S,J and NE."00
	asc	"You are at the prince's stone. With a little imagination, you can HOUSES images of the past."00
Janez	asc	"Du stehst vor einem Kasino neben Worther See.Um einzutreten mus man eine Krawatte haben. Strasen fuhren nach Ost,West und Sud."00
Janez	asc	"Du bist im Klagenfurt. Hier gibt es viele Sachen, aber du hast nicht genug Zeit und Geld.Gassen fuhren nach Nord,West und Nordwest."00
Janez	asc	"Du bist an einem See.Man sagt, das hier einmal auch ein Held, Tzchrthomyr genannt lebte.Du kannst zum Nordwest gehen."00
Janez	asc	"In Wein trinken alle Leute Wien. Aber du must die Reise fortsetzen.Grose Strassen gehenn ach Ost und Sudost."00
Janez	asc	"Jetzt bist du im Munchen.Hier kann man gute Computer und Bier kaufen.Winklige Strassen fuhrenn ach Ost,West und Sud."00
Janez	asc	"Du kommst in eine Bierstube,wo man gutes Bier trinken kann.Aber das Bier schadet der Gesundheit und du must nach Nord,West oder Nordost gehen."00
Janez	asc	"Jetzt bist du in einem grosen Geschaft fur Computer.Du siehst viele Computer,aber welcher ist der beste?Ist the of CBM or SINCLAIR ?"00
	...
	asc	"You are standing high in the mountains. Around you is full of sheep, and also comes their shepherd, who likes to look at the pictures."00
	asc	"Across the mountain pasture jumps joyful K.... and sings songs about his heroic deeds."00
	asc	"Fehta has come to you, who beats you for a piece of bread. Give her something, so don't eat you!"00
	asc	"You are on a small island in the middle of a lake. Their protege Vragumila is sunbathing on a deckchair in the middle of the nuns. She is thinking about to your beloved, but he can't go there."00
	...
	asc	"You're in a meeting bowling club Navje.Because the fights are interesting, there are lots of stones there to sit on."00
	...
	asc	"Below you see a city guarded by green dragon.On the castle tower it says: ATTENTION,FRESHLY PAINTED !!!"00
	asc	"Everything smells of the intoxicating scent of roses. But roses are painful thorns that's why you need gloves."00
	...
	asc	"You are standing by the sea. There also stands the ugly Vida, who can no longer do the daily washing. diapers. She also has all the necessary diving equipment from her husband."00
	asc	"You are in a clearing in the middle of the forest. The paths go S, E, W and NW."00
	asc	"You in the castle where Friderik lives, who only wants Veronika. Help him, and he will reward you!"00
	asc	"You are already on the Kolpa. The people here are very strong, some Klepec Tepec will uproot whole trees, if he only eat some sweet."00
	...
	asc	"You are in the castle where Predjama Erazemski lives."00
...
tblMESSAGES
	...
	asc	"Right. I'm rested, so let's go."00
	asc	"The game is over, it was a wild dance,"00
	asc	"Grateful man gives you an imported TV set from an abandoned program."00
	asc	"Glowing Friederik takes Veronika, and in gratitude gives you a pot of gold."00	; JANEZ
	asc	"PUFFF ..."00
	asc	"Friederik doesn't like the expression on Veronika's face anymore. He pulls out a sword and plunges it into your ribs. What a wild time!!!!"00
	asc	"Fancy Veronika didn't polish you!"00
	asc	""Let's go, dear," she decides, and then quickly jumps into your arms."00
	...
	asc	"Herman wants to keep Veronica, but your sword won't let him near it."00
	...
	asc	""Mmm,che buono!"says Tepec and puts down the beautiful oak planks that is holding."00
	asc	"Urban gives you barrels, saying: "Such barrels were made by my father for corrupt pastor."00
	asc	"Trubar: "I'm already too old to smuggle and contraband. Put Spectrum into barrel and it will be ok."00	; JANEZ
	...
	asc	"The customs officer doesn't fall for it: this is an old trick, hiding things in barrels."00
	...
	asc	"Beautiful Ursula is not grateful, but  pours you a bucket of ice-cold water.... You're slowly coming to your senses."00
	...
	asc	"Bravo! The answer is correct, that's why you got the Attache collection!"00
